...
namespace RpgApi.Controllers
{
    ...
    public class PersonagensExemploController : ControllerBase
    {
        private static List<Personagem> personagens = new List<Personagem>()
        {
            ...
            new Personagem() { Id = 7, Nome = "Karsen", PontosVida=110, Forca=32, Defesa=100, Inteligencia=80, Classe=ClasseEnum.Espadachim},
            new Personagem() { Id = 8, Nome = "Sofiz", PontosVida=100, Forca=15, Defesa=20, Inteligencia=60, Classe=ClasseEnum.Arqueiro}
        };
      ...
      /*  [HttpDelete("{id}")]
        public IActionResult RemoverPersonagem(Personagem DeletarPersonagem)
        {
            personagens.Remove(DeletarPersonagem);
            return Ok(personagens);
        } */
